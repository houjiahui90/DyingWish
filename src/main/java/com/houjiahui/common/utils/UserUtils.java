...
import com.houjiahui.core.security.SystemAuthorizingRealm;
...
import com.houjiahui.common.sms.SMSUtils;
import com.houjiahui.common.utils.CacheUtils;
import com.houjiahui.common.utils.SpringContextHolder;
import com.houjiahui.core.persistence.BaseEntity;
import com.houjiahui.core.service.BaseService;
//import com.nxzhxt.modules.sys.entity.Area;
//import com.nxzhxt.modules.sys.entity.DataRule;
//import com.nxzhxt.modules.sys.entity.Menu;
//import com.nxzhxt.modules.sys.entity.Office;
//import com.nxzhxt.modules.sys.entity.Role;
//import com.nxzhxt.modules.sys.mapper.AreaMapper;
//import com.nxzhxt.modules.sys.mapper.DataRuleMapper;
//import com.nxzhxt.modules.sys.mapper.MenuMapper;
//import com.nxzhxt.modules.sys.mapper.OfficeMapper;
//import com.nxzhxt.modules.sys.mapper.RoleMapper;
//import com.houjiahui.modules.sys.mapper.UserMapper;
import com.houjiahui.core.security.SystemAuthorizingRealm.Principal;
...
//	private static OfficeMapper officeMapper = SpringContextHolder.getBean(OfficeMapper.class);
	...
	public static final String USER_CACHE_LIST_BY_PHONE_NUMBER_ = "phone_";
	...
	public static final String CACHE_OFFICE_ITEM = "officeItem";
	public static final String OFFICE_CACHE_NAME = "office_cache_name_";
	...
	public static User get(String id,boolean useCache){
		User user = null;
		if (useCache) {
...
//		if (areaList == null){
//			Area temp = new Area();
//			temp.setDelFlag(BaseEntity.DEL_FLAG_NORMAL);
//			areaList = areaMapper.findAllList(temp);
...
//	}
	 ...
	 * @return
	 */
//	public static Office getUncertifiedOffice() {
//		String name = "未认证用户机构";
//		Office office = (Office) CacheUtils.get(CACHE_OFFICE_ITEM, OFFICE_CACHE_NAME + name);
//		if (office == null) {
//			office = officeMapper.getByName(name);
//			CacheUtils.put(CACHE_OFFICE_ITEM, OFFICE_CACHE_NAME + name, office);
//		}
//		return office;
//	}
	/**
	 ...
	 * @return
	 */
//	public static Office getCertifiedOffice_WeChat() {
//		String name = "微信认证用户机构";
//		Office office = (Office) CacheUtils.get(CACHE_OFFICE_ITEM, OFFICE_CACHE_NAME + name);
//		if (office == null) {
//			office = officeMapper.getByName(name);
//			CacheUtils.put(CACHE_OFFICE_ITEM, OFFICE_CACHE_NAME + name, office);
